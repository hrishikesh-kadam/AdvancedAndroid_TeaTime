...
// TODO COMPLETED (1) Implement ImageDownloader.DelayerCallback
...
public class MenuActivity extends AppCompatActivity implements ImageDownloader.DelayerCallback {
    ...
    // TODO COMPLETED (2) Add a SimpleIdlingResource variable that will be null in production

    @Nullable private SimpleIdlingResource mIdlingResource;

    /**
     * TODO COMPLETED (3) Create a method that returns the IdlingResource variable. It will
    ...
    public IdlingResource getIdlingResource() {
        Log.d(LOG_TAG, "-> getIdlingResource called because process in testing or debugging version");
    ...
    /**
     * TODO COMPLETED (4) Using the method you created, get the IdlingResource variable.
    ...
    // TODO COMPLETED (5) Override onDone so when the thread in ImageDownloader is finished, it returns an
